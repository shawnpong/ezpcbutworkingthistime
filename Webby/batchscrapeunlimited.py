...
async def insert_data(mymodels, manufacturers, sizes):
    ...
    # Remove duplicates from the sizes and manufacturers lists using set and dict conversions
    ...
    # Insert manufacturer data into the API
    async with httpx.AsyncClient() as batch_client:
